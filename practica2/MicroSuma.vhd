...
signal salida_reg : signed(31 downto 0);
signal salida_alu : signed(31 downto 0);
signal salida_inutil : signed(31 downto 0);
signal entrada_pc : unsigned(31 downto 0);
...
r2: ALURISCV port map (
	Op1=>salida_reg,
	Op2 => resize(signed(MemProgData(31 downto 20)),32),
	ALUControl=>"000",
	Res => salida_alu,
	Z => open
);
